...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchRepositories = async () => {
            try {
                    const res = await axios.get("https://gitorbit-backend.onrender.com/repo/all");
    ...
    const handleStar = async (repoId) => {
        try {
                await axios.put(`https://gitorbit-backend.onrender.com/repo/star/${repoId}`, {
                userID: currentUser
            });
            // Optimistic Update
    ...
    const handleFollow = async (e, ownerId) => {
        ...
        try {
            ...
            if (isFollowing) {
                 await axios.post(`https://gitorbit-backend.onrender.com/unfollow/${ownerId}`, { currentUserID: currentUser });
            } else {
                 await axios.post(`https://gitorbit-backend.onrender.com/follow/${ownerId}`, { currentUserID: currentUser });
            }
